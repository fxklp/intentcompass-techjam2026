...
| Multi-route recall | Keyword/category/exact/expanded/dense are independently queried, deduplicated and scored. Dense exploratory fusion may add candidates; ordinary proven Top-10 is preserved. | Direct tests plus route candidate counts in evaluation reports. | On. Route-only ordinary tail candidates are observed but do not displace the proven head. |
